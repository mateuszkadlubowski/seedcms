...
return [
    ...
    'alert' =>[
        'failed' => 'Formularz zawiera błędy.',
        'email_verify' => 'Wysłaliśmy link aktywacyjny na adres :email, aby w pełni korzystać z możliwości serwisu zweryfikuj swój email.'
    ],
