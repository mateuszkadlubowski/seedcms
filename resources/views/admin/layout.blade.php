...
<div class="admin-panel">
        ...
        <div class="admin-usermenu shadow-lg">
            ...
            <ul class="dropdown-menu">
                <li><a class="dropdown-item icon-user-edit"
                       href="#">{{ __('admin.usermenu.profile') }}</a></li>
    ...
    <nav class="admin-nav" id="admin-nav">
        <ul class="nav flex-column">
            <li class="nav-item">
                <a class="nav-link icon-admin {{ request()->routeIs('admin.index') ? 'active' : '' }}"
                   aria-current="page"
                   href="{{ route('admin.index') }}">{{ __('admin.index.name') }}</a>
            </li>
